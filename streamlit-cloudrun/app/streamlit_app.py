...
endpoint = aiplatform.Endpoint(
    endpoint_name="projects/989788194604/locations/europe-west4/endpoints/7163577739704795136"  # <---- CHANGE THIS !!!!
)

st.set_page_config(page_title="Llama 2-70B Chat deployed as Streamlit app")
...
if 'generated' not in st.session_state:
    st.session_state['generated'] = ["I'm llama-2 70B in Vertex AI, How may I help you?"]
